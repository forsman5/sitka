...
func _init(p_id: int, p_commodity: Commodity.Type, p_quantity: float, p_origin: int, p_destination: int, p_edge_id: int, p_departure_day: int, p_arrival_day: int) -> void:
	id = p_id
